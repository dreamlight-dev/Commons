 ...
 * The project is on <a href="https://github.com/MrMicky-FR/CustomInventory">GitHub</a>.
 *
 * @author MrMicky
 * @version 3.0.3
 */
public class CustomInventory implements InventoryHolder {
    ...
    /**
     * Create a new CustomInventory with a custom size.
     *
     * @param size The size of the inventory.
     */
    public CustomInventory(final int size) {
        this(size, InventoryType.CHEST.getDefaultTitle());
    }

    /**
     * Create a new CustomInventory with a custom size and title.
     *
     * @param size  The size of the inventory.
    ...
    /**
     * Create a new CustomInventory with a custom type.
     *
     * @param type The type of the inventory.
     */
    public CustomInventory(final InventoryType type) {
        this(Objects.requireNonNull(type, "type"), type.getDefaultTitle());
    }

    /**
     * Create a new CustomInventory with a custom type and title.
     *
     * @param type  The type of the inventory.
     * @param title The title of the inventory.
     */
    public CustomInventory(final InventoryType type, final String title) {
        this(0, Objects.requireNonNull(type, "type"), title);
    }

    private CustomInventory(final int size, final InventoryType type, final String title) {
        ...
        if (this.inventory.getHolder() != this) {
            throw new IllegalStateException("Inventory holder is not CustomInventory, found: " + this.inventory.getHolder());
        }
    }
     ...
     */
    public void addItem(final ItemStack item, final Consumer<InventoryClickEvent> handler) {
     ...
     */
    public void setItem(final int slot, final ItemStack item, final Consumer<InventoryClickEvent> handler) {
     ...
     * @param item     The item to add.
     */
    public void setItems(final int slotFrom, final int slotTo, final ItemStack item) {
     ...
     * @param handler  The click handler for the item
     */
    public void setItems(final int slotFrom, final int slotTo, final ItemStack item, final Consumer<InventoryClickEvent> handler) {
     ...
     * @param item  The item to add.
     */
    public void setItems(final int[] slots, final ItemStack item) {
     ...
     * @param handler The click handler for the item
     */
    public void setItems(final int[] slots, final ItemStack item, final Consumer<InventoryClickEvent> handler) {
        for (int slot : slots) {
            setItem(slot, item, handler);
        }
    }
     ...
     * @param handler The click handler for the item
     */
    public void setItems(final List<Integer> slots, final ItemStack item, final Consumer<InventoryClickEvent> handler){
        for(int slot : slots){
            setItem(slot, item, handler);
        }
    }
     ...
     * @param item    The item to add.
     */
    public void setItems(final List<Integer> slots, final ItemStack item){
        for(int slot : slots){
            setItem(slot, item);
        }
    }
     ...
     */
    public void setCloseFilter(final Predicate<Player> closeFilter) {
     ...
     */
    public void addOpenHandler(final Consumer<InventoryOpenEvent> openHandler) {
     ...
     */
    public void addCloseHandler(final Consumer<InventoryCloseEvent> closeHandler) {
     ...
     */
    public void addClickHandler(final Consumer<InventoryClickEvent> clickHandler) {
    ...
    void handleOpen(final InventoryOpenEvent e) {
        onOpen(e);

        this.openHandlers.forEach(c -> c.accept(e));
    }

    boolean handleClose(final InventoryCloseEvent e) {
        onClose(e);
    ...
    void handleClick(final InventoryClickEvent e) {
        ...
        final Consumer<InventoryClickEvent> clickConsumer = this.itemHandlers.get(e.getRawSlot());
